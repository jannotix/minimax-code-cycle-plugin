...
import { activeWorkflowForRequest, amendRequest, createWorkflow, latestWorkflow, loadRequest, loadWorkflow, requestDigestOf, saveWorkflow, } from "../store/workflows.js";
    ...
    switch (operation) {
        ...
        case "cancel":
            if (options.confirm !== true)
                throw new Error("cancel requires confirm: true");
            command = { type: "cancel" };
            break;
    }
